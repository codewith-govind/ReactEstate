...
const AppSidebar: React.FC = () => {
  ...
  useEffect(() => {
    ...
    ["main", "others"].forEach((menuType) => {
      const items = menuType === "main" ? newNavItems : othersItems;
  ...
  return (
    ...
    >
      <div className={`py-8 border-b hidden lg:flex justify-center`}>
        <h1 className="text-2xl uppercase dark:text-white/90 ">G K Groups</h1>
      </div>
        ...
        <nav className="mb-6">
          <div className="flex flex-col gap-4">
            <div>
              ...
              {renderMenuItems(newNavItems, "main")}
            </div>
            <div className="">
              {/* <h2
                className={`mb-4 text-xs uppercase flex leading-[20px] text-gray-400 ${
